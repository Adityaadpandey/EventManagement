...
export default function Auth() {
			...
			<div className="min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-purple-50 to-blue-50 p-4">
				<div className="bg-white rounded-xl shadow-lg max-w-md w-full p-8 space-y-6 border border-indigo-100 transition-all duration-300 hover:shadow-xl">
					<div className="text-center">
						<h1 className="font-bold text-3xl text-indigo-800 mb-2">Welcome Back!</h1>
						<p className="text-gray-600">You're ready to explore exciting events</p>
					</div>
					...
					{error ? <p className="text-red-600 text-sm font-medium bg-red-50 p-3 rounded-lg">{error}</p> : null}
				</div>
			</div>
		);
	}
	...
	return (
		<div className="min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-purple-50 to-blue-50 p-4">
			<div className="bg-white rounded-xl shadow-lg max-w-md w-full p-8 space-y-6 border border-indigo-100 transition-all duration-300 hover:shadow-xl">
				<div className="text-center">
					<h1 className="font-bold text-3xl text-indigo-800 mb-2">Join the Experience</h1>
					<p className="text-gray-600">Sign in to discover and book amazing events</p>
				</div>
